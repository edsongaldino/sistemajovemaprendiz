...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('atualizacoes_contrato', function (Blueprint $table) {
            DB::statement("ALTER TABLE atualizacoes_contrato MODIFY tipo ENUM('Entrega de Uniforme','Falta Trabalho','Atualização Contratual','Exame Admissional','Exame Demissional', 'Exame Periódico', 'Benefícios', 'Alteração Salarial', 'Férias')");
        });
    }

...
@section('conteudo')
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10"><i class="fa fa-user"></i> Editar Usuário</h6>
            <p class="mg-b-30 tx-gray-600">Preencha os dados abaixo para adicionar usuários internos</p>

            <div class="form-layout form-layout-2">
            <form name="FormUser" id="FormUser" action="{{ route('sistema.usuario.update') }}" method="POST">
                @csrf
                @php $acao = "editar"; @endphp
                @include('sistema.usuarios.form')
                <input type="hidden" name="id" value="{{ $usuario->id ?? '' }}">
                <button type="button" onclick="EnviarFormUser();" class="btn btn-info btn-gravar"> <i class="fa fa-save"></i> Atualizar usuário</button>
            </form>
            </div><!-- form-layout -->

...
@section('conteudo')
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            <form name="FormPolo" id="FormPolo" action="{{ route('sistema.polo.salvar') }}" method="POST">
                @csrf
                @include('sistema.polos.form')
                <button type="button" onclick="EnviarFormPolo();" class="btn btn-info btn-gravar"> <i class="fa fa-save"></i> Gravar pólo</button>
            </form>
            </div><!-- form-layout -->

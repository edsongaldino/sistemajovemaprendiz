...
@section('conteudo')
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
      <h4 class="tx-gray-800 mg-b-5"><i class="fa fa-user"></i> Usuários da Empresa ({{ $empresa->razao_social }})</h4>
      <p class="mg-b-0">Lista de usuários da empresa</p>
      <a href="#" title="Adicionar membro á equipe da empresa" data-toggle="modal" data-target="#ModalEquipe" data-whatever="@mdo"><button class="btn btn-incluir"><i class="fa fa-plus"></i> Adicionar à equipe (Empresa)</button></a>
    </div>

    <div class="br-pagebody">
      <div class="br-section-wrapper">
        <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Foram listados {{ $equipe->count() }} usuários</h6>
    ...
    <div class="modal fade" id="ModalEquipe" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form action="{{ route('sistema.empresa.equipe.adicionar') }}" method="POST">
                @csrf

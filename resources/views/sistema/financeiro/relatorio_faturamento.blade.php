...
<body>
    ...
    <div class="linha-relatorio">
        ...
        <div class="col-5">{{ Helper::getAtualizacaoContrato($faturamentoContrato->data_inicial,$faturamentoContrato->data_final, $faturamentoContrato->contrato_id, 'Qtde Falta Trabalho') }}</div>
        ...
        <div class="col-5">{{ $faturamentoContrato->FaturamentoContratoInstituicaoDados->valor_decimo_terceiro }}</div>
        <div class="col-5">{{ $faturamentoContrato->FaturamentoContratoInstituicaoDados->valor_ferias }}</div>
        <div class="col-5">{{ $faturamentoContrato->FaturamentoContratoInstituicaoDados->valor_terco_ferias }}</div>
        <div class="col-4">{{ $faturamentoContrato->FaturamentoContratoInstituicaoDados->valor_inss }}</div>
        <div class="col-4">{{ $faturamentoContrato->FaturamentoContratoInstituicaoDados->valor_fgts }}</div>
        <div class="col-4">-</div>
        <div class="col-4">{{ $faturamentoContrato->FaturamentoContratoInstituicaoDados->valor_inss_provisionamento }}</div>
        <div class="col-4">{{ $faturamentoContrato->FaturamentoContratoInstituicaoDados->valor_fgts_provisionamento }}</div>
        <div class="col-4">{{ $faturamentoContrato->FaturamentoContratoInstituicaoDados->valor_pis_provisionamento }}</div>

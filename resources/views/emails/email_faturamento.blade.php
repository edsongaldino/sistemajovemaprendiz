				...
				<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td class="logo" style="text-align: center; margin-top:30px;">
							<h1><a href="#"><img src="https://sistema.larjovemaprendiz.ong.br/assets/sistema/img/boleto/banner-boleto.jpg" alt="Logo" width="600"></a></h1>
						</td>
					</tr>
				</table>
			</td>
					...
					<tr>
						<td>
							...
							<div class="text" style="padding: 0 2.5em; text-align: center;">
								...
								<h2>Olá, </h2>
								<h2>Os contratos da sua empresa, referente ao <b>Programa Jovem Aprendiz: Lar Maria de Lourdes</b> foram faturados.</h2>
								<h3>Abaixo é possível visualizar relatório:</h3>
                            ...
                            <div class="text" style="padding: 0 2.5em; text-align: center;">
								<h3>Qualquer dúvida estamos à disposição</h3>
							</div>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-right: 10px;">
                      	<h3 class="heading">Jovem Aprendiz</h3>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                      	...
                      	<ul>
                            <li><span class="text">Av. Santa Tereza, 867 - Jupiara, Campo Verde - MT, 78843-072</span></li>
                            <li><span class="text">(66) 99988-9239 - Financeiro</span></a></li>
                        </ul>
                      </td>
                    </tr>
                  </table>
